...
sf = shapefile.Reader("/media/pick/Data/DCEP/GRASS/basel/poly_wgs84.shp")
shapes = sf.shapes()
...
fields = sf.fields
print(fields[1])
field1 = fields[1] # Building Height
...
#p = Pool(processes=4)
#p.map(processShapes, range(0,N))

print("Finished")
w.save('/media/pick/Data/DCEP/GRASS/basel/poly_rotated')
